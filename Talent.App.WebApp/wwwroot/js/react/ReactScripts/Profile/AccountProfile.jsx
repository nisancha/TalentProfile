...
export default class AccountProfile extends React.Component {
  ...
  updateWithoutSave(newValues) {
    console.log("profiledataUpdate", newValues);
  ...
  updateAndSaveData(newValues) {
    console.log("profiledataUpdateandSave", newValues);
    let newProfile = Object.assign({}, this.state.profileData, newValues);
    this.setState(
      {
        profileData: newProfile,
              ...
              <div className="profile">
                <form className="ui form">
                  <div className="ui grid">
                    ...
                    >
                      <PhotoUpload
                        imageId={this.state.profileData.profilePhoto} //profilephotoUrl
                        updateProfileData={this.updateWithoutSave}
                    ...
                    <FormItemWrapper
                      ...
                      tooltip="Tell Something About Your Self"
                    >
                      <SelfIntroduction
                        summary={this.state.profileData.selfIntroduction.summary}
                        description={this.state.profileData.selfIntroduction.description}
